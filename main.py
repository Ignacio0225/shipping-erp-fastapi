...
from app.progress_detail_roro.progress_detail_roro import router as progress_detail_roro_router
from app.progress_detail_container.progress_detail_container import router as progress_detail_container_router
...
app.include_router(progress_detail_roro_router)
app.include_router(progress_detail_container_router)
