# app/type_categories/type_categories_models.py
...
class TypeCategory(Base):
    ...
    creator = relationship('User', backref=backref('type_categories'),passive_deletes=True)  # 유저가 삭제되어도 db에 shipments가 남음
